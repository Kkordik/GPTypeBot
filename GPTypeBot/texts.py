...
guide_texts = {
    "en": {
        "guide1": {
            "description": '''@GPTypeBot allows you to ask ChatGPT questions and immediately send the result to any Telegram chat: private messages, private and public groups, notes, comments, etc. The bot does not have any access to the information and messages of the chat in which it is used.
...
<i>If the generation of the answer takes more than 10 seconds, a message will be displayed with a button above it. By clicking the button, we will enter the chat with the bot and receive our result.</i>''',
    ...
    "uk": {
        "guide1": {
             "description": '''@GPTypeBot надає можливість запитувати ChatGPT і одразу ж надсилати результат в будь-який чат Telegram: особистих повідомленнях, приватних і публічних групах, нотатках, коментарях тощо. При цьому бот не має жодного доступу до інформації та повідомлень чату, в якому його використовують.
