import asyncio
from GPTBot.classes.BotTables import Database, UsersTable, QueryTable, TopicTable, PaymentTable
from GPTBot.config import HOST, USER, PASSWORD, NAME, PORT
...
if __name__ == "GPTBot.database.run_db":
