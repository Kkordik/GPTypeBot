...
import GPTBot.classes.MainClasses
from GPTBot.texts import facts, texts
from aiogram.types import InlineQuery, InputTextMessageContent, InlineQueryResultArticle, Message
from GPTBot.config import INFO_PHOTO, WARNING_PHOTO, MISTAKE_PHOTO, ANSWER_PHOTO, INTRO_FILE_ID
from GPTBot.classes.Guide import GuidePage
from GPTBot.classes.Markers import BeginMarker, EndMarker
from typing import Union
from random import choices
from GPTBot.keyboards import message_tip_keyboard, start_keyboard
from GPTBot.classes.MainClasses import Topic
from GPTBot.database.run_db import topic_tb
from GPTBot.main_interface.context_call import context_message
...
class Tip:
    ...
    async def pm_button_reaction(self, bot, chat_id, user: aiogram.types.User,
                                 user_db: GPTBot.classes.MainClasses.User):
